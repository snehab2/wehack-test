    ...
    <section className='parent-container about-section bg-[#755642]'>
      ...
      <div className='about-group flex flex-wrap flex-column sm:flex-row md:flex-row: lg:flex-row'>
        <div className='child-container'>
            <div className='paragraph-1 flex flex-wrap flex-column gap-y-5'>
        ...
        <div className='child-container'>
            <img className="about-image h-auto max-w-76 sm:max-w-72 md:max-w-96 lg:max-w-full" src="./2024 images/IMG_0165.jpg" alt="wehack logo"></img>
        </div>
      </div>

      {/* group 2 */}
      <div className='about-group flex flex-wrap-reverse flex-column sm:flex-row md:flex-row: lg:flex-row pt-32 sm:pt-36 md:pt-48 lg:pt-72'>
        <div className='child-container'>
            <img className="about-image h-auto max-w-76 sm:max-w-72 md:max-w-96 lg:max-w-full" src="./2024 images/IMG_1752.jpg" alt="wehack logo"></img>
        </div>
        <div className='child-container'>
            <div className='paragraph-2 flex flex-wrap flex-column gap-y-5'>
