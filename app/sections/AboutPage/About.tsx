...
function About() {
  return (
    <section className='parent-container w-screen h-screen flex flex-wrap-reverse flex-column sm:flex-row md:flex-row lg:flex-row items-center justify-center gap-y-0.5 lg:gap-x-10 m-0 px-10 pt-24 pb-24 sm:pb-0 md:pb-0 lg:pb-0'>
