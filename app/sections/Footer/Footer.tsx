...
function Footer() {
  return (
    <div className='footer-container w-full h-auto flex flex-col items-center justify-center p-20 gap-y-10'>
        <div className='main-container w-full flex flex-wrap flex-col items-center content-center gap-y-6'>
        ...
        <div className='navigation-container w-full flex flex-wrap flex-col content-center justify-center gap-y-6'>
        ...
        <div className='contact-us-container w-full flex flex-wrap flex-col content-center justify-center gap-y-6'>
