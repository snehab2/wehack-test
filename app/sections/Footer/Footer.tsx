...
function Footer() {
  return (
    <div className='footer-container w-full h-auto flex flex-col md:flex-row lg:flex-row items-center justify-center md:items-end md:justify-end lg:items-end lg:justify-end py-10 px-10 md:px-20 lg:px-20 gap-y-10 md:gap-x-3 lg:gap-x-5'>
        ...
        <div className='contact-container w-full flex flex-wrap flex-row content-center items-center md:content-end md:items-end lg:content-end lg:items-end gap-x-4 md:w-1/2 lg:w-1/2'>
            {/* <h1 className='about-title text-[#FFE9D7] font-medium text-lg text-left'>Contact Us</h1> */}
