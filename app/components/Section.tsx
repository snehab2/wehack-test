...
function Section() {
  return (
    ...
    <section className='parent-container w-screen h-screen flex flex-wrap flex-column sm:flex-row md:flex-row lg:flex-row items-center justify-center gap-y-4 m-0 p-10'>
        <div className='child-container w-full sm:w-1/2 md:w-1/2 lg:w-1/2 h-1/2 sm:h-full md:h-full lg:h-full flex flex-wrap flex-row sm:flex-column md:flex-column lg:flex-column items-center justify-center'>
            <img className="h-auto max-w-full sm:max-w-sm md:max-w-md lg:max-w-lg" src="/LogoSparkle.png" alt="wehack logo"></img>
        </div>
        <div className='child-container w-full sm:w-1/2 md:w-1/2 lg:w-1/2 h-1/2 sm:h-full md:h-full lg:h-full flex flex-wrap flex-row sm:flex-column md:flex-column lg:flex-column items-center justify-center'>
